...
steps:
  ...
  postinfective-and-reactive-arthropathies---secondary:
    run: postinfective-and-reactive-arthropathies---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: postinfective-and-reactive-arthropathies---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
